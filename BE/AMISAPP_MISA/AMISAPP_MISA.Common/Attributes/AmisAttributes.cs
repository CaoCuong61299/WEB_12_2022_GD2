...
namespace AMISAPP_MISA.Common.Attributes
{
    public class AmisAttributes
    {
        /// <summary>
        ...
        public class StringLengthAtribute : Attribute
        {
            #region Field
            ...
            /// <param name="errorMessage">Tin nhắn lỗi trả về</param>
            /// Author: NCCONG (16/02/2022)
            public StringLengthAtribute(int lengthAtribute, string errorMessage)
            {
                LengthAtribute = lengthAtribute;
                ErrorMessage = errorMessage;
            }
