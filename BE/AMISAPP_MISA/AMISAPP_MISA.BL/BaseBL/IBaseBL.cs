...
namespace AMISAPP_MISA.BL.BaseBL
{
    public interface IBaseBL<T>
    {
        ...
        /// Author : NCCONG (08/03/2023)
        ServiceResponse InsertRecord(T record);
        ...
        /// <returns> Trả về 1 nếu insert thành công trả về 0 nếu insert thất bại</returns>
        /// Author : NCCONG (08/03/2023)
        ServiceResponse UpdateRecord(Guid recordId, T record);
        ...
        /// Author: NCCONG(09/03/2023)
        PagingResult<T> GetPagingAndFilter(int pageSize, int pageNumber, string workingShiftFilter,List<CustomParam> customParams);
